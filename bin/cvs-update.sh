...
find $PROJECT -follow -type f -name '*.properties'                                  -print0 2>/dev/null | xargs -0r chown          :cvs    && \
find $PROJECT -follow -type f -name '*.properties'                                  -print0 2>/dev/null | xargs -0r chmod g+w              && \
