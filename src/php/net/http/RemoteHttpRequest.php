 ...
 */
class RemoteHttpRequest extends Object {
    ...
    * Constructor
    */
   function __construct($host, $port, $uri, $headers = null) {
   ...
   function connect() {
      ...
      // Redirects mit neuer HttpRequest verfolgen
      if ($this->followRedirects && ($this->getResponseCode()==301 || $this->getResponseCode()==302)) {
         ...
         $request = new RemoteHttpRequest($host, 80, $uri, $headers);
