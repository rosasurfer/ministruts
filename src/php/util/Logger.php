...
class Logger extends Object {
   ...
   public static function handleException(Exception $exception) {
      ...
      if (Logger ::$display) {
         ...
         if (Logger ::$displayHtml) {
            echo '</script></img></select></textarea></i></b><div align="left" style="font:normal normal 12px/normal arial,helvetica,sans-serif"><b>Uncaught</b> '.nl2br($message)."<br>in <b>".$file.'</b> on line <b>'.$line.'</b><br>';
   ...
   private static function _log($message, $exception = null, $level = L_ERROR) {
      ...
      if (Logger ::$display) {
         ...
         if (Logger ::$displayHtml) {
            echo '</script></img></select></textarea></i></b><div align="left" style="font:normal normal 12px/normal arial,helvetica,sans-serif"><b>'.Logger ::$logLevels[$level].'</b>: '.nl2br($message)."<br>in <b>".$file.'</b> on line <b>'.$line.'</b><br>';
            if ($exception)
