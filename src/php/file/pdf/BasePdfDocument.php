...
class BasePdfDocument extends Object {
    ...
    */
   private $currentColour = array('r' => -1,
                                  'g' => -1,
                                  'b' => -1);
   /**
    * current colour for stroke operations (lines etc.)
    */
   private $currentStrokeColour = array('r' => -1,
                                        'g' => -1,
                                        'b' => -1);
   /**
    ...
    */
   private $options = array('compression' => 1);
   /**
   ...
   function stream($options='') {
     ...
     // 'Content-Disposition'=>'filename'  - Sets the filename, though not too sure how well this will work as in my trial
     //                                      the browser seems to use the filename of the php file with .pdf on the end.
     // 'Accept-Ranges'=>1 or 0            - If this is not set to 1, then this header is not included, off by default. This header
     //                                      seems to have caused some problems despite the fact that it is supposed to solve them,
     //                                      so I am leaving it off by default.
