...
<table align='center'>
 <tr>
  <td><a href="index.php"><img src="img_home.png" border="0"></a></td>
  <td><img src="img_sample.png" border="1"></td>
  <td><a href="download.php"><img src="img_download.png" border="0"></a></td>
 </tr>
</table>
<br><br>
<?
...
if (isset($barcode) && strlen($barcode)>0) {
   ...
   switch ($type) {
      case "I25":
         $obj = new I2Of5BarCode(250, 120, $style, $barcode);
         break;
      case "C39":
         $obj = new C39BarCode(250, 120, $style, $barcode);
         break;
      case "C128A":
         $obj = new C128ABarCode(250, 120, $style, $barcode);
         break;
      case "C128B":
         $obj = new C128BBarCode(250, 120, $style, $barcode);
         break;
      case "C128C":
         $obj = new C128CBarCode(250, 120, $style, $barcode);
         break;
      default:
         $obj = null;
   }
