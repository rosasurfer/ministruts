...
class DateTime extends \DateTime {
    ...
    public function __toString() {
        ...
        catch (\Throwable $ex) {                                                // Ensure __toString() doesn't throw an exception as otherwise...
            ErrorHandler::handleToStringException($ex);                         // PHP <7.4 will trigger a non-catchable fatal error.
        }
