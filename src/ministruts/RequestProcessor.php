...
class RequestProcessor extends CObject {
     ...
     * @param  Response $response
     *
     * @return ActionMapping|null - ActionMapping or NULL if no mapping responsible for processing the request was found
     */
...
PROCESS_METHOD_ERROR_SC_405;
     ...
     * @param  Action   $action
     *
     * @return ActionForward|null - ActionForward or NULL if request processing has already finished
     */
