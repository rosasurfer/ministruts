...
class MySQLConnector extends Connector {
   ...
   public function executeRaw($sql, &$affectedRows=0) {
      ...
      if (!$result) {
         ...
         $errMsg  = mysql_error($this->connection); !strLen($errMsg) && $errMsg='(no error)';
         $message = 'SQL-Error '.$errno.': '.$errMsg.NL.'SQL: "'.$sql.'"';
    ...
    *
    * This function returnes the ID generated by the last performed SQL query. The value is reset between queries. The SQL
    * function LAST_INSERT_ID() returns the value of the most recently generated ID which is not reset between queries.
    *
    * @return int - generated ID or 0 (zero) if the previous statement did not generate a new AUTO_INCREMENT value
    */
