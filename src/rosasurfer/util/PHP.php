   ...
   public static function phpInfo() {
      ...
      if (!CLI) {
         ...
         <div style="text-align:center; margin-bottom:15px; padding-top:20px; font-size:12px; font-weight:bold; font-family:sans-serif">
            <a href="?<?=$scriptStartQuery?>" style="display:inline-block; width:130px; height:15px; margin:0 10px; padding:10px; background-color:#ccf; color:#222; border:1px outset #666" title="PHP configuration at start of the script">     At Script Start</a>
            <a href="?<?=$appStartQuery   ?>" style="display:inline-block; width:130px; height:15px; margin:0 10px; padding:10px; background-color:#ccf; color:#222; border:1px outset #666" title="PHP configuration at start of the application">At Application Start</a>
            <a href="?<?=$scriptEndQuery  ?>" style="display:inline-block; width:130px; height:15px; margin:0 10px; padding:10px; background-color:#ccf; color:#222; border:1px outset #666" title="PHP configuration at end of the script">       At Script End</a>
         </div>
         <?php
         phpInfo();
      }
