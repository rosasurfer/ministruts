...
return array(
   ...
   'rosasurfer\\ministruts\\Action'                         => MINISTRUTS_ROOT.'/src/rosasurfer/ministruts/Action',
   'rosasurfer\\ministruts\\ActionForm'                     => MINISTRUTS_ROOT.'/src/rosasurfer/ministruts/ActionForm',
   'rosasurfer\\ministruts\\ActionForward'                  => MINISTRUTS_ROOT.'/src/rosasurfer/ministruts/ActionForward',
   'rosasurfer\\ministruts\\ActionMapping'                  => MINISTRUTS_ROOT.'/src/rosasurfer/ministruts/ActionMapping',
   'rosasurfer\\ministruts\\HttpSession'                    => MINISTRUTS_ROOT.'/src/rosasurfer/ministruts/HttpSession',
   'rosasurfer\\ministruts\\Module'                         => MINISTRUTS_ROOT.'/src/rosasurfer/ministruts/Module',
   'rosasurfer\\ministruts\\PageContext'                    => MINISTRUTS_ROOT.'/src/rosasurfer/ministruts/PageContext',
   'rosasurfer\\ministruts\\Request'                        => MINISTRUTS_ROOT.'/src/rosasurfer/ministruts/Request',
   'rosasurfer\\ministruts\\RequestProcessor'               => MINISTRUTS_ROOT.'/src/rosasurfer/ministruts/RequestProcessor',
   'rosasurfer\\ministruts\\Response'                       => MINISTRUTS_ROOT.'/src/rosasurfer/ministruts/Response',
   'rosasurfer\\ministruts\\RoleProcessor'                  => MINISTRUTS_ROOT.'/src/rosasurfer/ministruts/RoleProcessor',
   'rosasurfer\\ministruts\\StrutsController'               => MINISTRUTS_ROOT.'/src/rosasurfer/ministruts/StrutsController',
   'rosasurfer\\ministruts\\Tile'                           => MINISTRUTS_ROOT.'/src/rosasurfer/ministruts/Tile',
