...
if (ini_get('allow_call_time_pass_reference') && PHP_VERSION < '5.4') /*removed as of v5.4*/ $isWarning = 1|echoPre('Warning: allow_call_time_pass_reference is not Off');
...
if (ini_get('magic_quotes_gpc'))                                      /*removed as of v5.4*/ $isWarning = 1|echoPre('Warning: magic_quotes_gpc is not Off');
if (ini_get('magic_quotes_runtime'))                                  /*removed as of v5.4*/ $isWarning = 1|echoPre('Warning: magic_quotes_runtime is not Off');
...
if (!ini_get('y2k_compliance') && PHP_VERSION < '5.4')                /*removed as of v5.4*/ $isWarning = 1|echoPre('Warning: y2k_compliance is not On');
