 ...
 *
 * @method static \rosasurfer\core\io\cli\Input           instance()                            Get the object behind the proxy.
 * @method static \rosasurfer\core\io\cli\Input           setDocoptResult(DocoptResult $docopt) Set the internal docopt result.
...
class Input extends Proxy {
    ...
    protected static function getServiceName() {
        return 'input';
        return \rosasurfer\core\io\cli\Input::class;
    }
}
