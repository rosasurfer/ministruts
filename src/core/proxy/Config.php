 ...
 * @method static bool            bool(string $key, bool $strict = false, bool $default = false) Return the config setting with the specified key interpreted as a boolean. Accepted strict boolean representations are "1" and "0", "true" and "false", "on" and "off", "yes" and "no" (case-insensitive), as well as native boolean values.
