 ...
 * CliInput
 *
 * A {@link Proxy} for the CLI "input" {@link \rosasurfer\core\di\service\Service} which is registered in the service container.
 *
 ...
 * @method static bool|int                                hasCommand(string $name)              Whether the command with the given name was specified.<br><br> See {@link \rosasurfer\console\io\Input::isCommand()} for the definition of "command".
 ...
 * @method static ?string                                 getArgument(string $name)             Return the single-value argument or the first multi-value argument with the given name.<br> See {@link \rosasurfer\console\io\Input::isArgument()} for the definition of "argument".
 * @method static string[]                                getArguments(string $name)            Return the arguments with the given name.<br><br> See {@link \rosasurfer\console\io\Input::isArgument()} for the definition of "argument".
