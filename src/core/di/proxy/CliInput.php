 ...
 *
 * @method static \rosasurfer\ministruts\console\io\Input            instance()                            Get the object behind the proxy.
 * @method static \rosasurfer\ministruts\console\io\Input            setDocoptResult(DocoptResult $docopt) Set the internal Docopt result.
 * @method static \rosasurfer\ministruts\console\docopt\DocoptResult getDocoptResult()                     Return the internal Docopt result.
...
class CliInput extends Proxy {
    ...
    protected static function getServiceName() {
        return 'input';
        return \rosasurfer\ministruts\console\io\Input::class;
    }
}
