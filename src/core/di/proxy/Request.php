 ...
 * @method static \rosasurfer\ministruts\ActionInput        getInput()                                                                Return an object wrapper for all raw input parameters of the request. This includes GET and POST parameters.
