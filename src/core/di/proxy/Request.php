 ...
 * @method static \rosasurfer\ministruts\ActionInput        getInput()                                                                Return the {@link ActionInput} instance assigned to the request. The instance represents the request's raw input parameters.
 ...
 * @method static string[]                                  getParameters(string $name=null)                                          Return an array of $_REQUEST parameters with the specified name. A single transmitted $_REQUEST parameter with that name is ignored. Without a name all $_REQUEST parameters are returned.
 ...
 * @method static string[]                                  getGetParameters(string $name=null)                                       Return an array of $_GET parameters with the specified name. A single transmitted $_GET parameter with that name is ignored. Without a name all $_GET parameters are returned.
 ...
 * @method static string[]                                  getPostParameters(string $name=null)                                      Return an array of $_POST parameters with the specified name. A single transmitted $_POST parameter with that name is ignored. Without a name all $_POST parameters are returned.
