 ...
 * @method static ?\rosasurfer\ministruts\ActionMapping getMapping()                                                              Return the MiniStruts {@link ActionMapping} responsible for processing the current request.
 * @method static ?\rosasurfer\ministruts\Module        getModule()                                                               Return the MiniStruts {@link Module} the current request is assigned to.
 */
