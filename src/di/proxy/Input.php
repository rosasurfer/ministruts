 ...
 * @method static string?                                 getArgument(string $name)             Return the single-value argument or the first multi-value argument with the given name.<br> See Input::isArgument() for the definition of "argument".
