 ...
 * @method static ActionMapping|null             getMapping()                                                              Return the MiniStruts {@link ActionMapping} responsible for processing the current request.
 * @method static Module|null                    getModule()                                                                                                                                                            Return the MiniStruts {@link Module} the current request is assigned to.
 */
