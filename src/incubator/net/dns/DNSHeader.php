 ...
 *
 * The DNSHeader class contains the values of a DNS  packet.  It parses
...
class DNSHeader
{
    ...
    /* }}} */
    /* class constructor - DNSHeader($data = "") {{{ */
    /**
     * Initializes the default values for the DNSHeader object.
     *
     ...
     * @return  object  DNSHeader
     * @access public
     */
    function DNSHeader($data = '')
    {
        if (empty($data)) {
            $this->id      = DNSResolver::nextid();
            $this->qr      = 0;
            $this->opcode  = 0;
            $this->aa      = 0;
            $this->tc      = 0;
     ...
     *
     * Packs the properties of the DNSHeader object into a binary string
     * suitable for using as the DNSHeader section of a DNS packet.
     *
